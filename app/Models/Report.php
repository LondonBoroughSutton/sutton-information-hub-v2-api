...
class Report extends Model
{
    ...
    public function generateServicesExport(): self
    {
        $headings = [
            ...
            'Org Email',
            'Org Phone',
            'Support listing Reference ID',
            'Support listing Name',
            'Support listing Web Address',
            'Support listing Contact Name',
            'Last Updated',
            'Referral Type',
            'Referral Contact',
            'Status',
    ...
    public function generateReferralsExport(
        ...
        $headings = [
            ...
            'Referred to Support listing ID',
            'Referred to Support listing Name',
            'Date Made',
            'Date Complete',
            'Self/Champion',

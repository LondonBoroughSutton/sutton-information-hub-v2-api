...
namespace App\Emails\OrganisationAdminInviteFirstFollowUps;
...
class NotifyInviteeEmail extends Email
{
    ...
    {
        return config('hlp.notifications_template_ids.organisation_admin_invite_first_follow_ups.notify_invitee.email');
    }

    ...
    public static function create(string $objectId = null): BaseObject
    {
        return parent::create($objectId)
            ...
            ->paths(
                ...
                Paths\InformationPages\InformationPagesRootPath::create(),
                Paths\InformationPages\InformationPagesIndexPath::create(),
                Paths\InformationPages\InformationPagesNestedPath::create(),
                Paths\InformationPages\InformationPagesImagePath::create(),

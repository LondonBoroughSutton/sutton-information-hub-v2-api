    ...
    public static function create(string $objectId = null): BaseObject
    {
        return parent::create($objectId)
            ...
            ->paths(
                ...
                Paths\LocalAuthorities\LocalAuthoritiesRootPath::create(),
                ...
                Paths\NhsConditions\NhsConditionsNestedPath::create(),
                ...
                Paths\PendingOrganisationAdmins\PendingOrganisationAdminConfirmPath::create(),
